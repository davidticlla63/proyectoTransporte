...
@Named(value = "facturaListaController")
@SuppressWarnings("serial")
@ConversationScoped
public class FacturaListaController implements Serializable {
	...
	Logger log = Logger.getLogger(FacturaListaController.class);
			...
			if (formatoHoja.getNombre().equals("COMPLETO")) {
				if (formatoFactura.getNombre().equals("DOS COLUMNAS")) {
					url = urlPath
							...
							+ selectedFactura.isImpresion() + "&pTamano="
							+ tamano + "&pUnipersonal="
							+ empresaLogin.isUnipersornal();
				}
