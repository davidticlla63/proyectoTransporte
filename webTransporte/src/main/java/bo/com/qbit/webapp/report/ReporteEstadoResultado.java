...
@WebServlet("/ReporteEstadoResultado")
@SuppressWarnings("serial")
public class ReporteEstadoResultado  extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			String rutaReporte = urlPath+"resources/report/estado_resultado.jasper";
