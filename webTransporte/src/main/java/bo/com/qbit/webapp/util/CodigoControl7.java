...
import bo.com.qbit.webapp.controller.FacturaController;
...
public class CodigoControl7 {
	...
	Logger log = Logger.getLogger(CodigoControl7.class);
    ...
    public String obtenerCodigoControl(Date fechaFactura,
			Dosificacion dosificacion, double totalBolivianos, String nitCi) {
		try {
    ...
    public String obtenerCodigoControl2(Date fechaFactura,String numeroFactura,
			Dosificacion dosificacion, double totalBolivianos, String nitCi) {
		try {
			log.info("Certificar Codigo Control... ");
			SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
			...
			setNumeroAutorizacion(dosificacion.getNumeroAutorizacion());
			log.info("Autorizacion : "+dosificacion.getNumeroAutorizacion());
			setNumeroFactura(Integer.parseInt(numeroFactura));
			setNitci(nitCi);
			log.info("Nit Ci : "+nitCi);
			setFechaTransaccion(date);
			log.info("fecha : "+date);
    ...
    public String obtener() {
        ...
        System.out.println("VERHOEFF : "+ver.obtener(numFactura));
        ...
        System.out.println("SUMATORIA CADENA : "+sumaStr);
        // 5 digitos
        ...
        for (int u = 0; u < cifrado.length(); u++) {
            if (num == 0) {
              /*  numero0 = this.obtieneAscii(cifrado.toCharArray()[u]) + numero0;*/
            	numero0 = cifrado.charAt(u) + numero0;
            }
            if (num == 1) {
                numero1 = cifrado.charAt(u) + numero1;
            }
            if (num == 2) {
                numero2 = cifrado.charAt(u) + numero2;
            }
            if (num == 3) {
                numero3 = cifrado.charAt(u) + numero3;
            }
            if (num == 4) {
                numero4 = cifrado.charAt(u) + numero4;
            }
            num++;
            if (num == 5) {
                num = 0;
