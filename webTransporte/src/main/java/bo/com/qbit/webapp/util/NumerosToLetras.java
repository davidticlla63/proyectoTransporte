...
public class NumerosToLetras {
	...
	public static String convertNumberToLetterUs(String number)
			throws NumberFormatException {
		...
		int centavos = Integer.parseInt(String.valueOf(getDigitAt(
				...
				+ String.valueOf(getDigitAt(splitNumber[1], 0)));
		if (centavos == 0) {
			converted += "00/100 Dolares Americanos";
		} else {
			converted += String.valueOf(centavos) + "/100 Dolares Americanos";
		}
	...
	public static String convertNumberToLetterUs(double number) {
		try {
			return convertNumberToLetterUs(doubleToString(number));
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("Error en convertNumberToLetter..." + e);
			return null;
