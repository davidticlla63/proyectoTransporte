...
@WebServlet("/ReporteTest")
public class ReporteTest  extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request,
        ...
        Integer pGestion = Integer.parseInt(request.getParameter("pGestion"));
   		...
   		System.out.println("COMPROBANTE INGRESO=============>  pMes: "+pMes+", pGestion: "+pGestion+" ,pTipoComprobante: "+pTipoComprobante+", pSucursal: "+pSucursal+" ,pEmpresa: "+pEmpresa);
   		...
   		String rutaReporte = urlPath+"resources/report/comprobante_ingreso.jasper";
