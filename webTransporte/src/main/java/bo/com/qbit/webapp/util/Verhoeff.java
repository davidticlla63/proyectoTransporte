...
public class Verhoeff {
	...
	public int obtener(String cifra) {
		...
		for (int o = 0; o < numeroInvertido.length(); o++) {
			check = mul[check][per[((o + 1) % 8)][Integer
					.parseInt(numeroInvertido.substring(o, o + 1))]];
		}
		return inv[check];
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(verhoeff.obtener("12083")); 
		System.out.println(verhoeff.obtener("0")); 
		System.out.println(verhoeff.obtener("1810")); 
		System.out.println(verhoeff.obtener("04")); 
	}
