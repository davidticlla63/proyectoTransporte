...
@WebServlet("/ReporteLibroDiario")
@SuppressWarnings("serial")
public class ReporteLibroDiario  extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			Integer pIdMonedaEmpresa = Integer.parseInt(request.getParameter("pIdMonedaEmpresa"));
			...
			String rutaReporte = urlPath+"resources/report/libro_diario.jasper";
			...
			parameters.put("pIdMonedaEmpresa", pIdMonedaEmpresa);
