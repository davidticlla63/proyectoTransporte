...
@WebServlet("/ReporteBalanceGeneral")
@SuppressWarnings("serial")
public class ReporteBalanceGeneral  extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			String rutaReporte = urlPath+"resources/report/balance_general.jasper";
