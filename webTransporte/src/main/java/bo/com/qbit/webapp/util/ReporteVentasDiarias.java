...
@WebServlet("/ReporteVentasDiadias")
public class ReporteVentasDiarias extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			if (pEstado.doubleValue()==1) {
				 rutaReporte = urlPath
							+ "resources/report/Facturacion/reportVentaDiaria.jasper";
			}
			if (pEstado.doubleValue()==2) {
				 rutaReporte = urlPath
							+ "resources/report/Facturacion/reportVentaDiariaProducto.jasper";
			}
			if (pEstado.doubleValue()==3) {
				 rutaReporte = urlPath
							+ "resources/report/Facturacion/reportVentaDiariaServicio.jasper";
			}
			if (pEstado.doubleValue()==4) {
				 rutaReporte = urlPath
							+ "resources/report/Facturacion/reportVentaDiariaPorOrden.jasper";
			}
			...
			parameters.put("feacha_f", pFechaFin);
			parameters.put("fecha", new Integer(pFechaI));
			parameters.put("fecha_fin", new Integer(pFechaF));
